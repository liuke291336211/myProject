                            ...
                            <form action="${pageContext.request.contextPath}/user/saveUser.do" method="post">
                                <div class="tab-pane active" id="tab-label">
                                    ...
                                    <div class="row data-type">
                                        ...
                                        <div class="col-md-4 data text">
                                            <input type="password" class="form-control" name="password"  placeholder="用户密码" value="">
                                        </div>
                                        <div class="col-md-2 title">电话号码</div>
                                        <div class="col-md-4 data text">
                                            <input type="text" class="form-control" name="phoneNum" placeholder="电话号码" value="">
                                        </div>
                                        <div class="col-md-2 title">E-mail</div>
                                        <div class="col-md-4 data text">
