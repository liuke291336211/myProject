                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">E-mail</th>
                            ...
                            <tbody>
                            <c:forEach items="${userList.list}" var="usr">
                                <tr>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${userList.prePage}&size=${userList.pageSize}">上一页</a></li>
